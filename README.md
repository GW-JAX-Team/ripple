...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/GW-JAX-Team/ripple/main.svg)](https://results.pre-commit.ci/latest/github/GW-JAX-Team/ripple/main) [![CI](https://github.com/GW-JAX-Team/ripple/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/GW-JAX-Team/ripple/actions/workflows/CI.yml) [![coverage](https://img.shields.io/coveralls/github/GW-JAX-Team/ripple/main)](https://coveralls.io/github/GW-JAX-Team/ripple?branch=main) [![PyPI](https://img.shields.io/pypi/v/rippleGW.svg)](https://pypi.org/project/rippleGW/) [![Python](https://img.shields.io/pypi/pyversions/rippleGW.svg)](https://pypi.org/project/rippleGW/) [![docs](https://img.shields.io/badge/docs-online-blue)](https://gw-jax-team.github.io/ripple/) [![license](https://img.shields.io/badge/License-MIT-blue)](https://github.com/GW-JAX-Team/ripple/blob/main/LICENSE)
