...
def IMRPhenomXHM_Inter_Amp_21_int1(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = jnp.sqrt(eta - 4.0 * eta2) * (
            21.256776327599113 - 25.594352690383847 * eta + 30.14761650482866 * eta2
        )

        eqSpin = (
            jnp.sqrt(eta - 4.0 * eta2)
            * S
            * (
                -11.262044985632757
                - 1.8167045597937677 * S
                + eta
                * (-1.1798437990445079 + 6.344825546437461 * S - 4.881427482271166 * S2)
            )
        )

        uneqSpin = -3.6366100759176696 * pWF["dchi"] ** 2 * (
            1.0 - 4.0 * eta
        ) * eta - 31.60048733143782 * pWF["dchi"] * eta2 * (
            1.0 + 2.1502870640831855 * eta2
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_21_int1: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_21_int2(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        uneqSpin = (
            -25.856046423804255 * pWF["dchi"] * eta2 * (1.0 + 5.7871199275552 * eta2)
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_21_int2: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_33_int1(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                7.348313807306079
                + eta * (-60.248696675045565 - 37.07212326362276 * S)
                + 5.059236579431119 * S
                + eta2 * (159.68630712802727 + 83.33807316873204 * S)
            )
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_33_int1: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_33_int2(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                3.896260108714186
                + eta * (-33.707998325000965 - 61.1244771077077 * S)
                + 4.878506403725656 * S
                + eta2 * (91.31681057861915 + 196.40535070402336 * S)
            )
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_33_int2: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_32_int1(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        eqSpin = (
            jnp.sqrt(eta - 3.0 * eta2)
            * S
            * (
                2.9649243713119895
                + eta3 * (1790.8363334078751 - 5438.911035114849 * S)
                + eta * (-37.87005271181108 - 126.1263286618178 * S)
                + 4.063724538613828 * S
        ...
        uneqSpin = eta2 * (
            ...
            * (
                pWF["chi1L"] ** 2
                - 2.0 * pWF["chi1L"] * pWF["chi2L"]
                + pWF["chi2L"] ** 2
            )
            + (
                pWF["chi2L"] * (3.6527252109313233 - 7.324266404418883 * S)
                + pWF["chi1L"] * (-3.6527252109313233 + 7.324266404418883 * S)
            )
            * delta
        )
        ...
        total = (
            ...
            * sqroot
            / (1 + 1082.6574834474493 * eta1 + 10083.297670051445 * eta2)
        )

    else:
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_32_int1: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_32_int2(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                -2.726472456645038
                + 2.9454485454761827 * S
                + eta3
                * (10581.664858726683 - 8474.190197512324 * S - 11680.937129551317 * S2)
                + eta
                * (98.08119212251981 - 119.88112323140916 * S - 145.5079981415436 * S2)
                + 3.5684571473795095 * S2
                + eta2
                * (
                    -1595.8027347570667
                    + 1686.7137359336039 * S
                    + 2139.8290160628144 * S2
                )
                + eta4
                * (
                    -21488.25117198268
                    + 13866.428366595079 * S
                    + 20863.270079587106 * S2
                )
            )
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_32_int2: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_44_int1(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                4.26336253142121
                + eta * (-47.94914754514519 - 39.31284390368824 * S)
                + 3.0973959822174297 * S
                + eta2 * (119.70401520575753 + 106.91295627237112 * S)
            )
        )

        uneqSpin = (
            0.7262636326998003 * pWF["dchi"] ** 2 * (1.0 - 4.0 * eta) * eta
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_44_int1: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_44_int2(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                3.256591670091969
                + eta * (-38.38922554651356 - 25.286684856422735 * S)
                + 2.374434219852751 * S
                + eta2 * (96.41777041220982 + 64.74544118094362 * S)
            )
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_44_int2: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_21_int0(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = (
            0.872895771366973
            + 441.76285124642845 * eta
            - 24617.068739152524 * eta2
            + 518054.9485981792 * eta3
        )

        eqSpin = S * (
            -0.0720494539485585
            + eta * (-173.67847091983123 - 113.29725582509889 * S)
            - 0.2687302438646897 * S
            + eta2 * (3571.0393588230045 + 2640.919925429635 * S)
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_21_int0: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_21_dint0(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = (
            -0.8535048463050732
            - 93.1876950411214 * eta
            + 13641.071903017495 * eta2
            - 337621.44851304166 * eta3
        )

        eqSpin = S * (
            -1.2067842398131878
            + eta2 * (-1972.284151572111 - 8172.057025783849 * S)
            - 0.26539816223182355 * S
            + eta * (77.26350785961219 + 189.63365484152857 * S)
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_21_dint0: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_33_int0(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = (
            1.5852399637975103
            + 549.5183711492834 * eta
            - 34257.76380246282 * eta2
            + 743142.8286902909 * eta3
        )

        eqSpin = S * (
            0.7436306553052219
            + eta * (-89.49451655594787 - 174.5730646548662 * S)
            + 0.4253024979725725 * S
            + eta2 * (1185.1654325913717 + 6510.983041407191 * S)
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_33_int0: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_33_dint0(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = (
            -4.691600252198376
            + 101.4338937535679 * eta
            + 9262.994550540048 * eta2
            - 310993.1309846956 * eta3
        )

        eqSpin = S * (
            -4.198232394219111
            + eta2 * (-28714.904192060643 - 5100.09336069277 * S)
            - 0.40986595512314733 * S
            + eta * (734.7118618746317 + 292.04566260701574 * S)
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_33_dint0: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_32_int0(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = (
            0.24794156582503746
            + 115.81823862983131 * eta
            - 6626.167995915723 * eta2
            + 141004.29332593994 * eta3
        )

        eqSpin = (
            (0.21144389781375486 + 35.10041265469983 * eta - 1794.2301585086836 * eta2)
            * S
            + (0.2781735549493081 - 37.038950686633 * eta + 1258.628375238807 * eta2)
            * S2
            + (0.23428222791962147 - 63.98011009365723 * eta + 2118.213562899934 * eta2)
            * S3
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_32_int0: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_32_dint0(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = (
            -0.3391808620221253
            - 14.604141885467747 * eta
            + 3694.1706648870427 * eta2
            - 95482.02951271653 * eta3
        )

        eqSpin = S * (
            -1.2844502090793946
            + eta2 * (-5018.762853306415 - 6332.389157828062 * S)
            - 1.2356159239385598 * S
            + eta * (149.04865679660233 + 188.2052849646003 * S)
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_32_dint0: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_44_int0(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = (
            0.5664660641971224
            + 185.58965113823874 * eta
            - 11458.768824989507 * eta2
            + 249386.7511724409 * eta3
        )

        eqSpin = (
            (0.1741768776210781 - 9.365114803167128 * eta + 703.2622732011035 * eta2)
            * S
            + (
                0.20169229783048184
                - 62.13147149352512 * eta
                + 2833.5738711424974 * eta2
            )
            * S2
            + (0.4423803798742513 - 23.60535149579996 * eta - 994.9241585715828 * eta2)
            * S3
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_44_int0: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_44_dint0(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122018:
        ...
        noSpin = (
            -1.796444922382065 + 111.51170611049032 * eta - 1728.7493675776548 * eta2
        )

        eqSpin = S * (
            -1.842119860613924
            + eta2 * (-11235.484645624338 - 2927.019210835522 * S)
            - 0.36655273031432567 * S
            + eta * (312.34531117524097 + 128.64488103364167 * S)
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_44_dint0: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_21_int3(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122022:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_21_int3: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_21_int4(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122022:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_21_int4: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_33_int3(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122022:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_33_int3: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_33_int4(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122022:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_33_int4: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_44_int3(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122022:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_44_int3: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_44_int4(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122022:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_44_int4: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_32_int3(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122022:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_32_int3: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Amp_32_int4(pWF: dict, InterAmpFlag: int) -> float:
    ...
    if InterAmpFlag == 122022:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Inter_Amp_32_int4: version {InterAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Inter_Phase_21_p1(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = (
            918.976 * pWF["chi1L"] * jnp.sqrt(1.0 - 4.0 * eta)
            - 918.976 * pWF["chi2L"] * jnp.sqrt(1.0 - 4.0 * eta)
        ) * eta + (
            91.7679 * pWF["chi1L"] * jnp.sqrt(1.0 - 4.0 * eta)
            - 91.7679 * pWF["chi2L"] * jnp.sqrt(1.0 - 4.0 * eta)
        ) * eta2
...
def IMRPhenomXHM_Inter_Phase_32_p1(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = (
            ...
            * eta
            * (
                pWF["chi1L"] * (6.227738120444028 - 1.0 * eta)
                + pWF["chi2L"] * (-6.227738120444028 + 1.0 * eta)
            )
        )
...
def IMRPhenomXHM_Inter_Phase_44_p1(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        eqSpin = (
            ...
            * S2
            + eta
            * (492.60300000000007 - 9508.5 * eta + 57303.4 * eta2 - 109418.0 * eta3)
            * S3
        ) / eta
        ...
        uneqSpin = (
            ...
            * eta
            * (
                pWF["chi1L"] * (-3.0782778864970646 - 1.0 * eta)
                + pWF["chi2L"] * (3.0782778864970646 + 1.0 * eta)
            )
        )
...
def IMRPhenomXHM_Inter_Phase_21_p2(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = (
            ...
            * eta
            * (
                pWF["chi1L"] * (-1.6012352903357276 - 1.0 * eta)
                + pWF["chi2L"] * (1.6012352903357276 + 1.0 * eta)
            )
        )
...
def IMRPhenomXHM_Inter_Phase_33_p2(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = (
            ...
            * eta
            * (
                pWF["chi1L"] * (-1.3095134830606614 - 1.0 * eta)
                + pWF["chi2L"] * (1.3095134830606614 + 1.0 * eta)
            )
        )
...
def IMRPhenomXHM_Inter_Phase_32_p2(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = (
            ...
            * eta
            * (
                pWF["chi1L"] * (2.5769789177580837 - 1.0 * eta)
                + pWF["chi2L"] * (-2.5769789177580837 + 1.0 * eta)
            )
        )
...
def IMRPhenomXHM_Inter_Phase_44_p2(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = (
            ...
            * eta
            * (
                pWF["chi1L"] * (-1.0543062374352932 - 1.0 * eta)
                + pWF["chi2L"] * (1.0543062374352932 + 1.0 * eta)
            )
        )
...
def IMRPhenomXHM_Inter_Phase_33_p3(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        eqSpin = (223.601 - 3714.77 * eta + 19614.6 * eta2 - 34860.2 * eta3) * S + (
            314.317 - 5906.46 * eta + 36587.3 * eta2 - 74299.5 * eta3
        ) * S2

        uneqSpin = 223.651 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_32_p3(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 63.9466 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_44_p3(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 262.143 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_21_p4(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 65.3326 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_33_p4(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 30.484 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_32_p4(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = -132.244 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_44_p4(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 87.0832 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_21_p5(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 119.014 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_33_p5(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 54.9833 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_32_p5(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 112.714 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_44_p5(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 97.1364 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_21_p6(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 74.0984 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_33_p6(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 75.5162 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inter_Phase_44_p6(pWF: dict, InterPhaseFlag: int) -> float:
    ...
    if InterPhaseFlag == 122019:
        ...
        uneqSpin = 23.0759 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Intermediate_Amp_CollocationPoints(
    ...
    if version == 0:  # Equispaced
        deltaf = (pAmp["fAmpMatchIM"] - pAmp["fAmpMatchIN"]) / (
            pWFHM["nCollocPtsInterAmp"] - 1
        )
        idx = 0
        for i in range(pWFHM["nCollocPtsInterAmp"]):
            if pAmp["VersionCollocPtsInter"][i] == 1:
                # Add point
                pAmp["CollocationPointsFreqsAmplitudeInter"][idx] = (
                    pAmp["fAmpMatchIN"] + deltaf * i
                )
                ...
                pAmp["CollocationPointsFreqsAmplitudeInter"][idx + 1] = pAmp[
                    "CollocationPointsFreqsAmplitudeInter"
                ][idx]
    ...
    if pAmp["VersionCollocPtsInter"][0] == 1:
        pAmp["CollocationPointsValuesAmplitudeInter"][0] = (
            IMRPhenomXHM_Inspiral_Amp_Ansatz(powers_of_finsp, pWFHM, pAmp)
        )
        tmpnCollocPts += 1
        ...
        pAmp["CollocationPointsValuesAmplitudeInter"][1] = (
            IMRPhenomXHM_Inspiral_Amp_NDAnsatz(powers_of_finsp, pWFHM, pAmp)
        )
        tmpnCollocPts += 2
    ...
    if version_last == 1:  # Add point
        if pWFHM["MixingOn"] == 0:
            ...
            pAmp["CollocationPointsValuesAmplitudeInter"][tmpnCollocPts] = jnp.abs(
                SpheroidalToSpherical(
                    powers_of_fRD, pAmp22, pPhase22, pAmp, pPhase, pWFHM, pWF22
                )
            )
        tmpnCollocPts += 1
        ...
        if pWFHM["MixingOn"] == 0:
            ...
            pAmp["CollocationPointsValuesAmplitudeInter"][tmpnCollocPts + 1] = (
                IMRPhenomXHM_RD_Amp_DAnsatz(powers_of_fRD, pWFHM, pAmp)
            )
        else:
            pAmp["CollocationPointsValuesAmplitudeInter"][tmpnCollocPts] = jnp.abs(
                SpheroidalToSpherical(
...
def IMRPhenomXHM_Intermediate_Amp_Coefficients(
    ...
    IMRPhenomXHM_Intermediate_Amp_CollocationPoints(
...
def IMRPhenomXHM_Intermediate_Amp_delta0(
    ...
    if IntAmpFlag == 101:  # Linear
        ...
        f1mf42 = f1mf4 * f1mf4
        retVal = (
            -(d4 * f1 * f1mf4 * f4) + f42 * v1 + f12 * v4 - 2 * f1 * f4 * v4
        ) / f1mf42
        ...
        retVal = (
            -(d4 * f1 * f1mf2 * f1mf3 * f1mf4 * f2 * f2mf3 * f2mf4 * f3 * f3mf4 * f4)
            - f1 * f1mf3 * f1mf42 * f3 * f3mf42 * f42 * v2
            + f24
            * (
                -(f1 * f1mf42 * f42 * v3)
                + f33 * (f42 * v1 + f12 * v4 - 2 * f1 * f4 * v4)
        ...
        retVal = (
            -(d4 * f12 * f1mf32 * f1mf4 * f3 * f3mf4 * f4)
        ...
        retVal = (
            -(d4 * f12 * f1mf22 * f1mf32 * f1mf4 * f2 * f2mf3 * f2mf4 * f3 * f3mf4 * f4)
            - d1 * f1 * f1mf2 * f1mf3 * f1mf4 * f2 * f2mf3 * f2mf42 * f3 * f3mf42 * f42
            + 5 * f13 * f24 * f33 * f42 * v1
            - 4 * f12 * f25 * f33 * f42 * v1
            - 5 * f13 * f23 * f34 * f42 * v1
            + 3 * f1 * f25 * f34 * f42 * v1
            + 4 * f12 * f23 * f35 * f42 * v1
            - 3 * f1 * f24 * f35 * f42 * v1
            - 10 * f13 * f24 * f32 * f43 * v1
            + 8 * f12 * f25 * f32 * f43 * v1
            + 5 * f12 * f24 * f33 * f43 * v1
            - 4 * f1 * f25 * f33 * f43 * v1
            + 10 * f13 * f22 * f34 * f43 * v1
            - 5 * f12 * f23 * f34 * f43 * v1
            - f25 * f34 * f43 * v1
            - 8 * f12 * f22 * f35 * f43 * v1
            + 4 * f1 * f23 * f35 * f43 * v1
            + f24 * f35 * f43 * v1
            + 5 * f13 * f24 * f3 * f44 * v1
            - 4 * f12 * f25 * f3 * f44 * v1
            + 15 * f13 * f23 * f32 * f44 * v1
            - 10 * f12 * f24 * f32 * f44 * v1
            - f1 * f25 * f32 * f44 * v1
            - 15 * f13 * f22 * f33 * f44 * v1
            + 5 * f1 * f24 * f33 * f44 * v1
            + 2 * f25 * f33 * f44 * v1
            - 5 * f13 * f2 * f34 * f44 * v1
            + 10 * f12 * f22 * f34 * f44 * v1
            - 5 * f1 * f23 * f34 * f44 * v1
            + 4 * f12 * f2 * f35 * f44 * v1
            + f1 * f22 * f35 * f44 * v1
            - 2 * f23 * f35 * f44 * v1
            - 10 * f13 * f23 * f3 * f45 * v1
            + 5 * f12 * f24 * f3 * f45 * v1
            + 2 * f1 * f25 * f3 * f45 * v1
            - f12 * f23 * f32 * f45 * v1
            + 2 * f1 * f24 * f32 * f45 * v1
            - f25 * f32 * f45 * v1
            + 10 * f13 * f2 * f33 * f45 * v1
            + f12 * f22 * f33 * f45 * v1
            - 3 * f24 * f33 * f45 * v1
            - 5 * f12 * f2 * f34 * f45 * v1
            - 2 * f1 * f22 * f34 * f45 * v1
...
def IMRPhenomXHM_Intermediate_Amp_delta1(
    ...
    if IntAmpFlag == 101:  # Linear, only v1, v2
        ...
        retVal = (
            d4 * f1 * f1mf4 * (f1 + 2 * f4)
            - f4 * (d1 * (-2 * f12 + f1 * f4 + f42) + 6 * f1 * (v1 - v4))
        ) / f1mf43
        ...
        retVal = (
            ...
            * (f1 * f2 * f3 + f2 * f3 * f4 + f1 * (f2 + f3) * f4)
            + (
                f4
                * (
                    f12 * f1mf42 * f43 * v2mv3
                    + f34 * (f43 * v1mv2 + 3 * f12 * f4 * v2mv4 + 2 * f13 * (-v2 + v4))
                    + f32
                    * f4
                    * (f44 * v1mv2 + 4 * f13 * f4 * v2mv4 + 3 * f14 * (-v2 + v4))
                    + 2
                    * f33
                    * (f44 * (-v1 + v2) + f14 * v2mv4 + 2 * f12 * f42 * (-v2 + v4))
                    + 2
                    * f23
                    * (
                        f44 * v1mv3
        ...
        retVal = (
            ...
            * f2mf4
            * f3mf4
            * (f1 * f2 * f3 + 2 * f2 * f3 * f4 + f1 * (f2 + f3) * f4)
            + f4
            * (
                d1
                * f1mf2
                ...
                * f2mf42
                * f3mf42
                * (2 * f1 * f2 * f3 + f2 * f3 * f4 + f1 * (f2 + f3) * f4)
                + f1
                * (
                    f16
                    * (
                    ...
                    * (
                    ...
                    + f1
                    * (
                        -(f32 * f3mf42 * (4 * f3 + 3 * f4) * f43 * (v1 - v2))
                        + 2
                        * f23
                        * (
                            f45 * (-v1 + v3)
...
def IMRPhenomXHM_Intermediate_Amp_delta2(
    ...
    if IntAmpFlag == 101:  # Linear, only v1, v2
        ...
        retVal = (
            -(d4 * f1mf32 * f1mf4 * f3mf4 * (f12 + f3 * f4 + 2 * f1 * (f3 + f4)))
        ...
        retVal = (
            ...
            * (
            ...
            + 4 * f1 * f23 * f35 * f4 * v1
            - 3 * f24 * f35 * f4 * v1
            - 15 * f13 * f24 * f3 * f42 * v1
            + 12 * f12 * f25 * f3 * f42 * v1
            + 5 * f1 * f24 * f33 * f42 * v1
            - 4 * f25 * f33 * f42 * v1
            + 15 * f13 * f2 * f34 * f42 * v1
            - 5 * f1 * f23 * f34 * f42 * v1
            - 12 * f12 * f2 * f35 * f42 * v1
            + 4 * f23 * f35 * f42 * v1
            + 10 * f13 * f24 * f43 * v1
            - 8 * f12 * f25 * f43 * v1
            + 20 * f13 * f23 * f3 * f43 * v1
            - 15 * f12 * f24 * f3 * f43 * v1
            - 20 * f13 * f2 * f33 * f43 * v1
            + 5 * f24 * f33 * f43 * v1
            - 10 * f13 * f34 * f43 * v1
            + 15 * f12 * f2 * f34 * f43 * v1
            - 5 * f23 * f34 * f43 * v1
            + 8 * f12 * f35 * f43 * v1
            - 15 * f13 * f23 * f44 * v1
            + 10 * f12 * f24 * f44 * v1
            ...
            * f2mf3
            * (
                f13 * (f22 + f2 * f3 + f32 - 3 * f42)
                + f2 * f3 * f4 * (3 * f2 * f3 - 4 * (f2 + f3) * f4 + 5 * f42)
                + f1
                * (f2 * f3 + 2 * (f2 + f3) * f4)
                * (3 * f2 * f3 - 4 * (f2 + f3) * f4 + 5 * f42)
                + f12
                * (
                    2 * f2 * f3 * (f2 + f3)
                    + (f22 + f2 * f3 + f32) * f4
...
def IMRPhenomXHM_Intermediate_Amp_delta3(
    ...
    if IntAmpFlag == 101:  # Linear, only v1, v2
        ...
        retVal = (
            d4 * f1mf2 * f1mf3 * f1mf4 * f2mf3 * f2mf4 * f3mf4 * (f1 + f2 + f3 + f4)
            + f34 * f42 * v1
            - 3 * f32 * f44 * v1
            + 2 * f3 * f45 * v1
            + f14 * f32 * v2
        ...
        retVal = (
            ...
            * f2mf4
            * f3mf4
            * (f12 + f2 * f3 + (f2 + f3) * f4 + 2 * f1 * (f2 + f3 + f4))
            + d1
            * f1mf2
            * f1mf3
            * f1mf4
            ...
            * f2mf42
            * f3mf42
            * (f1 * f2 + f1 * f3 + f2 * f3 + 2 * (f1 + f2 + f3) * f4 + f42)
            - 5 * f13 * f24 * f32 * v1
            + 4 * f12 * f25 * f32 * v1
            + 5 * f13 * f22 * f34 * v1
            - 2 * f25 * f34 * v1
            ...
            - 5 * f13 * f24 * f42 * v1
            + 4 * f12 * f25 * f42 * v1
            + 10 * f12 * f24 * f3 * f42 * v1
            - 8 * f1 * f25 * f3 * f42 * v1
            - 5 * f1 * f24 * f32 * f42 * v1
            + 4 * f25 * f32 * f42 * v1
            + 5 * f13 * f34 * f42 * v1
            - 10 * f12 * f2 * f34 * f42 * v1
            + 5 * f1 * f22 * f34 * f42 * v1
            - 4 * f12 * f35 * f42 * v1
            + 8 * f1 * f2 * f35 * f42 * v1
            - 4 * f22 * f35 * f42 * v1
            - 5 * f12 * f24 * f43 * v1
            + 4 * f1 * f25 * f43 * v1
            - 20 * f13 * f22 * f3 * f43 * v1
            + 10 * f1 * f24 * f3 * f43 * v1
            + 20 * f13 * f2 * f32 * f43 * v1
            - 5 * f24 * f32 * f43 * v1
            + 5 * f12 * f34 * f43 * v1
            - 10 * f1 * f2 * f34 * f43 * v1
            + 5 * f22 * f34 * f43 * v1
...
def IMRPhenomXHM_Intermediate_Amp_delta4(
    ...
    if IntAmpFlag == 101:  # Linear, only v1, v2
        ...
        retVal = (
            -(d4 * f1mf2 * f1mf3 * f1mf4 * f2mf3 * f2mf4 * f3mf4)
            - f33 * f42 * v1
            + 2 * f32 * f43 * v1
            - f3 * f44 * v1
            - f13 * f32 * v2
        ...
        retVal = (
            -(d4 * f1mf32 * f1mf4 * f3mf4)
            + d1 * f1mf3 * f1mf4 * f3mf42
            - 3 * f1 * f32 * v1
            + 2 * f33 * v1
            + 6 * f1 * f3 * f4 * v1
            - 3 * f32 * f4 * v1
        ...
        retVal = (
            ...
            * (f1 + f2 + f3 + 2 * f4)
            ...
            + 5 * f13 * f23 * f42 * v1
            - 3 * f1 * f25 * f42 * v1
            + 15 * f13 * f22 * f3 * f42 * v1
            - 10 * f12 * f23 * f3 * f42 * v1
            - 15 * f13 * f2 * f32 * f42 * v1
            + 5 * f1 * f23 * f32 * f42 * v1
            - 5 * f13 * f33 * f42 * v1
            + 10 * f12 * f2 * f33 * f42 * v1
            - 5 * f1 * f22 * f33 * f42 * v1
            + 3 * f1 * f35 * f42 * v1
            - 10 * f13 * f22 * f43 * v1
            + 5 * f12 * f23 * f43 * v1
            + f25 * f43 * v1
            + 15 * f12 * f22 * f3 * f43 * v1
            - 10 * f1 * f23 * f3 * f43 * v1
            + 10 * f13 * f32 * f43 * v1
            - 15 * f12 * f2 * f32 * f43 * v1
            + 5 * f23 * f32 * f43 * v1
            - 5 * f12 * f33 * f43 * v1
            + 10 * f1 * f2 * f33 * f43 * v1
            - 5 * f22 * f33 * f43 * v1
            ...
            * (
                ...
                + 2 * f12 * (f2 + f3 - 2 * f4)
                - 3 * (f22 + f2 * f3 + f32) * f4
                + f1 * (f22 + 5 * f2 * f3 + f32 - 6 * (f2 + f3) * f4 + 5 * f42)
                + 5 * f43
            )
            * v4
        ) / (f1mf22 * f1mf32 * f1mf43 * f2mf3 * f2mf42 * f3mf42)
...
def IMRPhenomXHM_Intermediate_Amp_delta5(
    ...
    if IntAmpFlag == 101:
        ...
        retVal = (
            ...
            - 4 * f12 * f23 * f42 * v1
            + 3 * f1 * f24 * f42 * v1
            - 12 * f12 * f22 * f3 * f42 * v1
            + 8 * f1 * f23 * f3 * f42 * v1
            + 12 * f12 * f2 * f32 * f42 * v1
            - 4 * f23 * f32 * f42 * v1
            + 4 * f12 * f33 * f42 * v1
            - 8 * f1 * f2 * f33 * f42 * v1
            + 4 * f22 * f33 * f42 * v1
            ...
            * f1mf32
            * f2mf3
            * (2 * f2 * f3 + f1 * (f2 + f3 - 2 * f4) - 3 * (f2 + f3) * f4 + 4 * f42)
            * v4
        ) / (f1mf22 * f1mf32 * f1mf43 * f2mf3 * f2mf42 * f3mf42)
