...
These feed :func:`ripplegw.waveforms.cw.barycenter.emission_delay`, which
assembles the *full* barycentering delay (Roemer + Earth-rotation + Einstein -
Shapiro) used by ``XLALGeneratePulsarSignal`` — as opposed to the
geometric-only delay used by the exact reference signal.
"""
...
from ripplegw.waveforms.cw.time_utils import GPS_EPOCH_2000, leap_seconds_since_2000
...
def earth_state(
    ...
    sun_pos_now, _sun_vel_now = _interp_ephemeris(
