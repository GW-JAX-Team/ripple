...
def evaluate_QNMfit_fring32(finalDimlessSpin: float) -> float:
    ...
    numerator = (
        0.09540436245212061
        - 0.13628306966373951 * finalDimlessSpin
    ...
    denominator = (
        1
        - 1.6531854335715193 * finalDimlessSpin
...
def evaluate_QNMfit_fdamp21(finalDimlessSpin: float) -> float:
    ...
    denominator = (
        146.1779212636481
        - 219.81790388304876 * finalDimlessSpin
        + 17.7141194900164 * x2
...
def evaluate_QNMfit_fdamp33(finalDimlessSpin: float) -> float:
    ...
    denominator = (
        1.0
        - 2.0963684630756894 * finalDimlessSpin
...
def evaluate_QNMfit_fdamp44(finalDimlessSpin: float) -> float:
    ...
    denominator = (
        1.0
        - 1.1350205970682399 * finalDimlessSpin
...
def evaluate_QNMfit_re_l2m2lp2(finalDimlessSpin: float) -> float:
    ...
    numerator = (
        1
        - 2.2956993576253635 * finalDimlessSpin
    ...
    denominator = (
        1
        - 2.2956977727459043 * finalDimlessSpin
...
def evaluate_QNMfit_im_l2m2lp2(finalDimlessSpin: float) -> float:
    ...
    numerator = finalDimlessSpin * (
        0.3826673013161342
        - 0.47531267226013896 * finalDimlessSpin
    ...
    denominator = (
        -38.70835035062785
        + 69.82140084545878 * finalDimlessSpin
...
def evaluate_QNMfit_re_l3m2lp2(finalDimlessSpin: float) -> float:
    ...
    numerator = finalDimlessSpin * (
        0.47513455283841244
        - 0.9016636384605536 * finalDimlessSpin
    ...
    denominator = (
        -6.76894063440646
        + 15.170831931186493 * finalDimlessSpin
        - 9.406169787571082 * x2
        + 1.0 * x4
    )
...
def evaluate_QNMfit_im_l3m2lp2(finalDimlessSpin: float) -> float:
    ...
    numerator = finalDimlessSpin * (
        -2.8704762147145533
        + 4.436434016918535 * finalDimlessSpin
    ...
    denominator = (
        -171.80908957903395
        + 272.362882450877 * finalDimlessSpin
...
def evaluate_QNMfit_re_l2m2lp3(finalDimlessSpin: float) -> float:
    ...
    numerator = finalDimlessSpin * (
        18.522563276099167
        - 37.978140351289014 * finalDimlessSpin
    ...
    denominator = (
        164.52480238697507
        - 377.9093045285145 * finalDimlessSpin
...
def evaluate_QNMfit_im_l2m2lp3(finalDimlessSpin: float) -> float:
    ...
    numerator = finalDimlessSpin * (
        -49.7688437256778
        + 120.43773704442333 * finalDimlessSpin
    ...
    denominator = (
        2858.5790831181725
        - 6305.619505422591 * finalDimlessSpin
...
def evaluate_QNMfit_re_l3m2lp3(finalDimlessSpin: float) -> float:
    ...
    numerator = (
        1
        - 2.107852425643677 * finalDimlessSpin
    ...
    denominator = (
        1
        - 2.1078515887706324 * finalDimlessSpin
...
def evaluate_QNMfit_im_l3m2lp3(finalDimlessSpin: float) -> float:
    ...
    numerator = finalDimlessSpin * (
        12.45701482868677
        - 29.398484595717147 * finalDimlessSpin
    ...
    denominator = (
        345.52914639836257
        - 815.4349339779621 * finalDimlessSpin
