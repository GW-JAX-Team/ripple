    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                ...
                - 0.008044970210401218 * S
                + eta2
                * (
                    -0.4735861262934258
                    - 0.5985436493302649 * S
                    - 0.08217216660522082 * S2
                )
            )
        )

        uneqSpin = (
            -0.257787704938017 * pWF["dchi"] * eta2 * (1.0 + 8.75928187268504 * eta2)
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_21_iv1: version {InspAmpFlag} is not valid."
        )
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                ...
                + eta * (0.09512553997347649 + 0.116470975986383 * S)
                - 0.009520793625590234 * S
                + eta2
                * (
                    -0.3409769288480959
                    - 0.8321002363767336 * S
        ...
        uneqSpin = -0.2962753588645467 * pWF["dchi"] * eta2 * (
            1.0 + 1.3993978458830476 * eta2
        ) - 0.17100612756133535 * pWF["dchi"] * eta2 * S * (
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_21_iv2: version {InspAmpFlag} is not valid."
        )
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                ...
                - 0.006952154764487417 * S
                + eta2
                * (
                    -0.016643018304732624
                    - 0.12702579620537421 * S
                    + 0.004623467175906347 * S2
                )
                - 0.007685497720848461 * S2
            )
        )

        uneqSpin = -0.3172310538516028 * pWF["dchi"] * (
            1.0 - 2.9155919835488024 * eta2
        ) * eta2 - 0.11975485688200693 * pWF["dchi"] * eta2 * S * (
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_21_iv3: version {InspAmpFlag} is not valid."
        )
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    -7.657635515668849
                    - 0.07646730296478217 * S
                    + 5.343277927456605 * S2
                )
            )
        )

        uneqSpin = (
            0.45866449225302536 * pWF["dchi"] * (1.0 - 9.603750707244906 * eta2) * eta2
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_33_iv1: version {InspAmpFlag} is not valid."
        )
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                ...
                + 0.05924304311104228 * S
                + eta
                * (1.6484440612224325 - 0.4683932646001618 * S - 2.110311135456494 * S2)
                + 0.10701786057882816 * S2
                + eta2
                * (-6.51575737684721 + 1.6692205620001157 * S + 8.351789152096782 * S2)
            )
        )

        uneqSpin = (
            0.3929315188124088 * pWF["dchi"] * (1.0 - 11.289452844364227 * eta2) * eta2
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_33_iv2: version {InspAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Insp_Amp_33_iv3(pWF: dict, InspAmpFlag: int) -> float:
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                0.04573095188775319
                + 0.048249943132325494 * S
                + eta
                * (
                    0.15922377052827502
                    - 0.1837289613228469 * S
                    - 0.2834348500565196 * S2
                )
        ...
        uneqSpin = (
            0.25187274502769835 * pWF["dchi"] * (1.0 - 12.172961866410864 * eta2) * eta2
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_33_iv3: version {InspAmpFlag} is not valid."
        )
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                ...
                - 0.0038263656140933152 * S
                + 0.018963579407636953 * S2
                + eta2
                * (
                    -1.955352354930108
                    + 2.3753413452420133 * S
                    - 0.9085620866763245 * S3
                )
                + 0.02738043801805805 * S3
                + eta3
                * (
                    7.977057990568723
                    - 7.9259853291789515 * S
                    + 0.49784942656123987 * S2
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_32_iv1: version {InspAmpFlag} is not valid."
        )
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                ...
                - 0.00362963820787208 * S
                + 0.016978054142418417 * S2
                + eta
                * (
                    0.24280554040831698
                    + 0.15878436411950506 * S
                    - 0.1470288177047577 * S3
                )
                + 0.029465887557447824 * S3
                + eta3
                * (
                    4.649438233164449
                    - 0.7550771176087877 * S
                    + 0.3381436950547799 * S2
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_32_iv2: version {InspAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Insp_Amp_32_iv3(pWF: dict, InspAmpFlag: int) -> float:
    ...
    if InspAmpFlag == 122018:
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_32_iv3: version {InspAmpFlag} is not valid."
        )
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            ...
            * (
                ...
                + 0.044702230915643903 * S
                + eta
                * (
                    0.6600413908621988
                    + 0.12149520289658673 * S
                    - 0.4482406547006759 * S2
                )
                + 0.07327810908370004 * S2
                + eta2
                * (
                    -2.1705970511116486
                    - 0.6512813450832168 * S
                    + 1.1237234702682313 * S2
                )
            )
        )

        uneqSpin = (
            0.4766851579723911 * pWF["dchi"] * (1.0 - 15.950025762198988 * eta2) * eta2
            + 0.127900699645338
            * pWF["dchi"] ** 2
            * (1.0 - 15.79329306044842 * eta2)
            * eta2
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_44_iv1: version {InspAmpFlag} is not valid."
        )
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = (
            (
                ...
                + 0.26110236039648027 * eta
                - 1.1536009170220438 * eta2
            )
            * S
            + (
                0.04479727299752669
                - 0.1439868858871802 * eta
                + 0.05736387085230215 * eta2
            )
            * S2
            + (
                0.06028104440131858
                - 0.4759412992529712 * eta
                + 1.1090751649419717 * eta2
            )
            * S3
        )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_44_iv2: version {InspAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Insp_Amp_44_iv3(pWF: dict, InspAmpFlag: int) -> float:
    ...
    if InspAmpFlag == 122018:
        ...
        eqSpin = S * (
            0.03488890057062679
            + 0.039491331923244756 * S
            + eta
            * (
                -0.08968833480313292
                - 0.12754920943544915 * S
                - 0.11199012099701576 * S2
            )
        ...
        raise ValueError(
            f"Error in IMRPhenomXHM_Insp_Amp_44_iv3: version {InspAmpFlag} is not valid."
        )
...
def IMRPhenomXHM_Insp_Phase_21_lambda(pWF: dict, InspPhaseFlag: int) -> float:
    ...
    if InspPhaseFlag == 122019:
        ...
        ) / (6.880288191574696 + 1.0 * S)

        uneqSpin = -134.27742343186577 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Insp_Phase_33_lambda(pWF: dict, InspPhaseFlag: int) -> float:
    ...
    if InspPhaseFlag == 122019:
        ...
        noSpin = (
            4.1138398568400705
            + 9.772510519809892 * eta
            - 103.92956504520747 * eta2
        ...
        eqSpin = (
            (
                -0.13253553909611435
                + 26.644159828590055 * eta
                - 105.09339163109497 * eta2
            )
            * S
...
def IMRPhenomXHM_Insp_Phase_32_lambda(pWF: dict, InspPhaseFlag: int) -> float:
    ...
    if InspPhaseFlag == 122019:
        ...
        uneqSpin = (
            ...
            * (
                -105.34550407768225
                - 1566.1242344157668 * pWF["chi1L"] * eta
                + 1566.1242344157668 * pWF["chi2L"] * eta
...
def IMRPhenomXHM_Insp_Phase_44_lambda(pWF: dict, InspPhaseFlag: int) -> float:
    ...
    if InspPhaseFlag == 122019:
        ...
        noSpin = (
            5.254484747463392
            - 21.277760168559862 * eta
            + 160.43721442910618 * eta2
            - 1162.954360723399 * eta3
            + 1685.5912722190276 * eta4
            - 1538.6661348106031 * eta5
        )

        eqSpin = (
            0.007067861615983771
            - 10.945895160727437 * eta
            + 246.8787141453734 * eta2
            - 810.7773268493444 * eta3
        ) * S + (
            0.17447830920234977
            + 4.530539154777984 * eta
            - 176.4987316167203 * eta2
            + 621.6920322846844 * eta3
        ) * S2

        uneqSpin = -8.384066369867833 * pWF["dchi"] * jnp.sqrt(1.0 - 4.0 * eta) * eta2
...
def IMRPhenomXHM_Inspiral_Phase_AnsatzInt(
    Mf: float, powers_of_Mf: dict, pPhase: dict
) -> float:
    """
...
def IMRPhenomXHM_Inspiral_Phase_Ansatz(
    ...
    for i in range(N_MAX_COEFFICIENTS_PHASE_INS):
        dphilm += (
            (pPhase["phi"][i] + pPhase["phiL"][i] * logMf) * coeffs[i]
            + pPhase["phiL"][i]
        ) * freqs[i]
    ...
    if IMRPhenomXHMInspiralAmpVersion == 3:  # 3 inspiral collocation points (default)
        retVal = (
            ...
            * (
                ...
                + powers_of_f2["three"]
                * (
                    powers_of_f3["eight_thirds"] * v1
                    - powers_of_f1["eight_thirds"] * v3
                )
                + powers_of_f2["eight_thirds"]
                * (-(powers_of_f3["three"] * v1) + powers_of_f1["three"] * v3)
            )
        ) / (
            powers_of_f1["seven_thirds"]
        ...
        retVal = (powers_of_fcutInsp["seven_thirds"] * v1) / powers_of_f1[
            "seven_thirds"
        ]

    elif (
        IMRPhenomXHMInspiralAmpVersion == 0
    ):  # No collocation points, reconstruct with PN only
        retVal = 0.0
    ...
    if IMRPhenomXHMInspiralAmpVersion == 3:  # 3 inspiral collocation points (default)
        ...
        retVal = (
            -(
                powers_of_fcutInsp["eight_thirds"]
                * (
                    -(powers_of_f2["seven_thirds"] * v1)
                    + powers_of_f1["seven_thirds"] * v2
                )
            )
        ) / (
            powers_of_f1["seven_thirds"]
...
def IMRPhenomXHM_Inspiral_PNAmp_Ansatz(
    powers_of_Mf: dict, pWFHM: dict, pAmp: dict
) -> float:
    """
    ...
    if pAmp["InspRescaleFactor"] == 0:
        pnAmp *= (
            pAmp["PNglobalfactor"] * powers_of_Mf["m_seven_sixths"] * pWFHM["ampNorm"]
        )
...
def IMRPhenomXHM_Inspiral_PNAmp_21Ansatz(
    ...
    if InsAmpFlag == 122018:
        ...
        x_to_m_one_four = (
            two_to_m_one_sixths * (lalpi ** (-1.0 / 6.0)) * powers_of_Mf["m_one_sixth"]
        )
...
def IMRPhenomXHM_Inspiral_Amp_Ansatz(
    ...
    if pWFHM["IMRPhenomXHMInspiralAmpFreqsVersion"] == 122018:
        ...
        InspAmp = (
            ...
            + powers_of_Mf["seven_thirds"]
            / pAmp["fcutInsp_seven_thirds"]
            * pAmp["rho1"]
            + powers_of_Mf["eight_thirds"]
            / pAmp["fcutInsp_eight_thirds"]
            * pAmp["rho2"]
        ...
        pseudoterms = (
            powers_of_Mf["seven_thirds"]
            / pAmp["fcutInsp_seven_thirds"]
            * pAmp["InspiralCoefficient"][0]
            + powers_of_Mf["eight_thirds"]
            / pAmp["fcutInsp_eight_thirds"]
            * pAmp["InspiralCoefficient"][1]
            + powers_of_Mf["three"]
            / pAmp["fcutInsp_three"]
            * pAmp["InspiralCoefficient"][2]
        )
...
def IMRPhenomXHM_Inspiral_Amplitude_Veto(
    ...
    if (
        ...
        < threshold * powers_of_f1["seven_sixths"]
    ):
        new_iv1 = 0.0
        new_version = 2
    ...
    if (
        ...
        < threshold * powers_of_f2["seven_sixths"]
    ):
        new_iv2 = 0.0
    ...
    if (
        ...
        < threshold * powers_of_f3["seven_sixths"]
    ):
        new_iv3 = 0.0
        new_version = new_version - 1
...
def IMRPhenomXHM_Inspiral_Amp_CollocationPoints(
    ...
    pAmp_out["CollocationPointsValuesAmplitudeInsp"] = [0.0] * pWFHM[
        "nCollocPtsInspAmp"
    ]
...
def IMRPhenomXHM_Inspiral_Amp_Coefficients(
    pAmp: dict, powers_of_Mf_inspcollpoints: list, pWFHM: dict
) -> dict:
    """
    ...
    v1 = (
        (pAmp["CollocationPointsValuesAmplitudeInsp"][0] - pAmp["PNAmplitudeInsp"][0])
        / pAmp["PNdominant"]
        / powers_of_f1["m_seven_sixths"]
    )
    v2 = (
        (pAmp["CollocationPointsValuesAmplitudeInsp"][1] - pAmp["PNAmplitudeInsp"][1])
        / pAmp["PNdominant"]
        / powers_of_f2["m_seven_sixths"]
    )
    v3 = (
        (pAmp["CollocationPointsValuesAmplitudeInsp"][2] - pAmp["PNAmplitudeInsp"][2])
        / pAmp["PNdominant"]
    ...
    if InspAmpVersion == 1:
        ...
        pAmp_out["InspiralCoefficient"][1] = (
            ...
            * (
                powers_of_f1["m_seven_thirds"] * v1
                - powers_of_f2["m_seven_thirds"] * v2
            )
            / (powers_of_f1["one_third"] - powers_of_f2["one_third"])
        )
        ...
        pAmp_out["InspiralCoefficient"][1] = (
            ...
            * (
                powers_of_f1["m_seven_thirds"] * v1
                - powers_of_f3["m_seven_thirds"] * v3
            )
            / (powers_of_f1["one_third"] - powers_of_f3["one_third"])
        )
...
def IMRPhenomXHM_Get_Inspiral_Amp_Coefficients(
    pAmp: dict, pWFHM: dict, pWF22: dict
) -> dict:
    """
    ...
    pAmp_updated, pWFHM_updated = IMRPhenomXHM_Inspiral_Amp_CollocationPoints(
        pAmp, pWFHM, pWF22
    )
    ...
    pAmp_updated["fcutInsp_seven_thirds"] = powers_of_Mf_inspcollpoints[
        pWFHM["nCollocPtsInspAmp"]
    ]["seven_thirds"]
    pAmp_updated["fcutInsp_eight_thirds"] = powers_of_Mf_inspcollpoints[
        pWFHM["nCollocPtsInspAmp"]
    ]["eight_thirds"]
    pAmp_updated["fcutInsp_three"] = powers_of_Mf_inspcollpoints[
        pWFHM["nCollocPtsInspAmp"]
    ]["three"]
