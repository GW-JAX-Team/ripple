"""
IMRPhenomX inspiral phase functions converted to JAX.

This module contains the inspiral phase coefficient functions for the
IMRPhenomX waveform model, converted from the LALSimulation C code to JAX.
"""


def IMRPhenomX_Inspiral_Phase_22_d13(
    eta: float, S: float, dchi: float, delta: float, InspPhaseFlag: int
) -> float:
    """
    Compute the d13 coefficient for the 22 mode inspiral phase.

    This function calculates the d13 phase coefficient using different fitting
    formulas depending on the InspPhaseFlag parameter. The coefficient includes
    contributions from non-spinning, equal-spin, and unequal-spin terms.

    Args:
        eta: Symmetric mass ratio
        S: Effective spin parameter
        dchi: Spin difference parameter (chi1L - chi2L)
        delta: Mass asymmetry parameter sqrt(1 - 4*eta)
        InspPhaseFlag: Flag to select the fitting formula:
            104: Canonical, 3 pseudo PN terms
            105: Canonical, 4 pseudo PN terms
            114: Extended, 3 pseudo PN terms
            115: Extended, 4 pseudo PN terms

    Returns:
        The d13 phase coefficient
    ...
    if InspPhaseFlag == 104:  # Canonical, 3 pseudo PN terms
        noSpin = (
            -17294.000000000007 - 19943.076428555978 * eta + 483033.0998073767 * eta2
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    -58475.33302037833
                    + 62190.404951852535 * S
                    + 18298.307770807573 * S2
                    - 303141.1945565486 * S3
                )
                ...
                * (
                    -148368.4954044637
                    - 758386.5685734496 * S
                    - 137991.37032619823 * S2
                    + 1.0765877367729193e6 * S3
                )
        ...
        noSpin = (
            -14234.000000000007 + 16956.107542097994 * eta + 176345.7518697656 * eta2
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    -918.541450687484
                    + 2531.457116826593 * S
                    - 14325.55532310136 * S2
                    - 19213.48002675173 * S3
                )
                + 1517.4561843692861 * S3
                + eta2
                * (
                    -517.7142591907573
                    - 14328.567448748548 * S
                    + 21305.033147575057 * S2
                    + 50143.99945676916 * S3
                )
            )
        ) / (
            0.03332712934306297
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    57814.07222969789
                    + 344650.11918139807 * S
                    + 17020.46497164955 * S2
                    - 574047.1384792664 * S3
                )
                + 24626.598127509922 * S3
                + eta
                * (
                    23058.264859112394
                    - 16563.935447608965 * S
                    - 36698.430436426395 * S2
                    + 105713.91549712936 * S3
                )
            )
        ...
        noSpin = (
            -29240.00000000001
            - 12488.41035199958 * eta
            + 1.3911845288427814e6 * eta2
            - 3.492477584609041e6 * eta3
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    122185.06346551726
                    + 351091.59147835104 * S
                    - 37366.6143666202 * S2
                    - 505834.54206320125 * S3
                )
                + 20386.815769841945 * S3
                + eta
                * (
                    -9638.828456576934
                    - 30683.453790630676 * S
                    - 15694.962417099561 * S2
                    + 91690.51338194775 * S3
                )
            )
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Phase_22_d13: InspPhaseFlag={InspPhaseFlag} is not valid. "
            f"Valid values are 104, 105, 114, 115."
        )

    return noSpin + eqSpin + uneqSpin


def IMRPhenomX_Inspiral_Phase_22_d23(
    eta: float, S: float, dchi: float, delta: float, InspPhaseFlag: int
) -> float:
    """
    Compute the d23 coefficient for the 22 mode inspiral phase.

    This function calculates the d23 phase coefficient using different fitting
    formulas depending on the InspPhaseFlag parameter. The coefficient includes
    contributions from non-spinning, equal-spin, and unequal-spin terms.
    ...
    Args:
        ...
        delta: Mass asymmetry parameter sqrt(1 - 4*eta)
        InspPhaseFlag: Flag to select the fitting formula:
            104: Canonical, 4 pseudo PN coefficients
            105: Canonical, 5 pseudo PN coefficients
            114: Extended, 4 pseudo PN coefficients
            115: Extended, 5 pseudo PN coefficients

    Returns:
        The d23 phase coefficient
    ...
    if InspPhaseFlag == 104:  # Canonical, 4 pseudo PN coefficients
        noSpin = (
            -7579.300000000004
            - 120297.86185566607 * eta
            + 1.1694356931282217e6 * eta2
            - 557253.0066989232 * eta3
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    150022.21343386435
                    - 50166.382087278434 * S
                    - 399712.22891153296 * S2
                )
    ...
    elif InspPhaseFlag == 105:  # Canonical, 5 pseudo PN coefficients
        noSpin = (
            -7520.900000000003 - 49463.18828584058 * eta + 437634.8057596484 * eta2
        ...
        noSpin = (
            -17762.000000000007
            - 1.6929191194109183e6 * eta
            + 8.420903644926643e6 * eta2
        ...
        eqSpin = (
            ...
            * (
                ...
                + eta2
                * (
                    1.2502334322912344e6
                    + 1.4500798116821344e6 * S
                    - 1.4822181506831646e6 * S2
                )
                - 41234.966418619966 * S2
                + eta
                * (
                    -24017.33452114588
                    - 15241.079745314566 * S
                    + 136554.48806839858 * S2
                )
                + eta3
                * (
                    -3.584298922116994e6
                    - 3.9566921791790277e6 * S
    ...
    elif InspPhaseFlag == 115:  # Extended, 5 pseudo PN coefficients
        noSpin = (
            -18482.000000000007
            - 1.2846128476247871e6 * eta
            + 4.894853535651343e6 * eta2
            + 3.1555931338015324e6 * eta3
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    30934.123894659646
                    + 58636.235226102894 * S
                    - 32465.70372990005 * S2
                    - 38032.16219587224 * S3
                )
                ...
                * (
                    -38410.1127729419
                    - 87088.84559983511 * S
                    + 61286.73536122325 * S2
                    + 42503.913487705235 * S3
                )
            )
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Phase_22_d23: InspPhaseFlag={InspPhaseFlag} is not valid. "
            f"Valid values are 104, 105, 114, 115."
        )
...
def IMRPhenomX_Inspiral_Phase_22_v3(
    eta: float, S: float, dchi: float, delta: float, InspPhaseFlag: int
) -> float:
    """
    Compute the v3 coefficient for the 22 mode inspiral phase.

    This function calculates the v3 phase coefficient using different fitting
    formulas depending on the InspPhaseFlag parameter. The coefficient includes
    contributions from non-spinning, equal-spin, and unequal-spin terms.
    ...
    if InspPhaseFlag == 104:  # Canonical, 3 pseudo PN terms
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    4.662143741417853e6
                    - 584728.050612325 * S
                    - 1.6894189124921719e6 * S2
                )
                + eta
                * (
                    -1.0053073129700898e6
                    + 1.235279439281927e6 * S
                    - 174952.69161683554 * S2
                )
                - 130668.37221912303 * S2
                + eta2
                * (
                    -1.9826323844247842e6
                    + 208349.45742548333 * S
                    + 895372.155565861 * S2
                )
            )
        ) / (
        ...
        noSpin = (
            68014.00000000003
            + 1.1513072539654972e6 * eta
            - 2.725589921577228e6 * eta2
            + 312571.92531733884 * eta3
        ...
        eqSpin = (
            ...
            * (
                ...
                + (
                    23618.044919850676
                    - 89494.69555164348 * eta
                    + 725554.5749749158 * eta4
                    - 103449.15865381068 * eta2
                )
                * S
                + (
                    10350.863429774612
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    -102.4982890239095
                    + 2570.7566494633033 * S
                    - 2915.1250015652076 * S2
                )
                ...
                * (
                    -1635.6270690726785
                    - 13745.336370568011 * S
                    + 19539.310912464192 * S2
                )
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Phase_22_v3: InspPhaseFlag={InspPhaseFlag} is not valid. "
            f"Valid values are 104, 105, 114, 115."
        )
...
def IMRPhenomX_Inspiral_Phase_22_d43(
    eta: float, S: float, dchi: float, delta: float, InspPhaseFlag: int
) -> float:
    """
    Compute the d43 coefficient for the 22 mode inspiral phase.

    This function calculates the d43 phase coefficient using different fitting
    formulas depending on the InspPhaseFlag parameter. The coefficient includes
    contributions from non-spinning, equal-spin, and unequal-spin terms.
    ...
    Args:
        ...
        delta: Mass asymmetry parameter sqrt(1 - 4*eta)
        InspPhaseFlag: Flag to select the fitting formula:
            104: Canonical, 3 pseudo PN coefficients
            105: Canonical, 4 pseudo PN coefficients
            114: Extended, 3 pseudo PN coefficients
            115: Extended, 4 pseudo PN coefficients

    Returns:
        The d43 phase coefficient
    ...
    if InspPhaseFlag == 104:  # Canonical, 3 pseudo PN coefficients
        noSpin = (
            2439.000000000001 - 31133.52170083207 * eta + 28867.73328134167 * eta2
    ...
    elif InspPhaseFlag == 105:  # Canonical, 4 pseudo PN coefficients
        noSpin = (
            4085.300000000002
    ...
    elif InspPhaseFlag == 114:  # Extended, 3 pseudo PN coefficients
        noSpin = (5749.000000000003 - 37877.95816426952 * eta) / (
            1.0 + 1.1883386102990128 * eta
        )
    ...
    elif InspPhaseFlag == 115:  # Extended, 4 pseudo PN coefficients
        noSpin = (
            9760.400000000005
            + 9839.852773121198 * eta
            - 398521.0434645335 * eta2
            + 267575.4709475981 * eta3
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Phase_22_d43: InspPhaseFlag={InspPhaseFlag} is not valid. "
            f"Valid values are 104, 105, 114, 115."
        )
...
def IMRPhenomX_Inspiral_Phase_22_d53(
    eta: float, S: float, dchi: float, delta: float, InspPhaseFlag: int
) -> float:
    """
    Compute the d53 coefficient for the 22 mode inspiral phase.

    This function calculates the d53 phase coefficient using different fitting
    formulas depending on the InspPhaseFlag parameter. The coefficient includes
    contributions from non-spinning, equal-spin, and unequal-spin terms.

    Note: This coefficient is only used for 5 pseudo PN coefficient cases (105, 115).
    Cases 104 and 114 (which use 3-4 pseudo PN coefficients) will raise an error.
    ...
    Returns:
        The d53 phase coefficient

    Raises:
        ValueError: If InspPhaseFlag is not 105 or 115
    """
    eta2 = eta * eta
    eta3 = eta2 * eta
    ...
    if InspPhaseFlag == 104:
        raise ValueError(
            "Error in IMRPhenomX_Inspiral_Phase_22_d53: InspPhaseFlag=104 corresponds to "
            "4 pseudo-PN coefficients, but d53 is only used for 5 pseudo-PN coefficients. "
        ...
        noSpin = (
            5474.400000000003
            + 131008.0112992443 * eta
            - 1.9692364337640922e6 * eta2
            + 1.8732325307375633e6 * eta3
        ...
        eqSpin = (
            ...
            * (
                ...
                * (
                    219014.98908698096
                    - 307162.33823247004 * S
                    - 124111.02067626518 * S2
                )
    ...
    elif InspPhaseFlag == 114:
        raise ValueError(
            "Error in IMRPhenomX_Inspiral_Phase_22_d53: InspPhaseFlag=114 corresponds to "
            "4 pseudo-PN coefficients, but d53 is only used for 5 pseudo-PN coefficients. "
            "This should not be called."
        )
        ...
        noSpin = (
            12971.000000000005 - 93606.05144508784 * eta + 102472.4473167639 * eta2
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Phase_22_d53: InspPhaseFlag={InspPhaseFlag} is not valid. "
            f"Valid values are 105, 115 (5 pseudo-PN coefficient cases only)."
        )
...
def IMRPhenomX_Inspiral_Amp_22_v2(
    ...
    Args:
        eta: Symmetric mass ratio
        S: Effective spin parameter (chiPNHat)
        dchi: Spin difference parameter
        delta: Mass asymmetry parameter
        InsAmpFlag: Version flag for inspiral amplitude model

    Returns:
        Amplitude collocation point value
    """
    eta2 = eta * eta
    eta3 = eta2 * eta
    eta4 = eta3 * eta
    ...
    if InsAmpFlag == 103:
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Amp_22_v2: InsAmpFlag={InsAmpFlag} is not valid. "
...
def IMRPhenomX_Inspiral_Amp_22_v3(
    ...
    if InsAmpFlag == 103:
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Amp_22_v3: InsAmpFlag={InsAmpFlag} is not valid. "
            f"Valid values are 103."
        )
...
def IMRPhenomX_Inspiral_Amp_22_v4(
    ...
    if InsAmpFlag == 103:
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Amp_22_v4: InsAmpFlag={InsAmpFlag} is not valid. "
            f"Valid values are 103."
        )
...
def IMRPhenomX_Inspiral_Amp_22_rho1(
    ...
    Args:
        ...
        F1: Frequency at 2/4 f^A_T
        F2: Frequency at 3/4 f^A_T
        F3: Frequency at 4/4 f^A_T
        InsAmpFlag: Version flag for inspiral amplitude model
    ...
    if InsAmpFlag == 103:
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Amp_22_rho1: InsAmpFlag={InsAmpFlag} is not valid. "
            f"Valid values are 103."
        )
...
def IMRPhenomX_Inspiral_Amp_22_rho2(
    ...
    if InsAmpFlag == 103:
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Amp_22_rho2: InsAmpFlag={InsAmpFlag} is not valid. "
            f"Valid values are 103."
        )
...
def IMRPhenomX_Inspiral_Amp_22_rho3(
    ...
    if InsAmpFlag == 103:
        ...
        raise ValueError(
            f"Error in IMRPhenomX_Inspiral_Amp_22_rho3: InsAmpFlag={InsAmpFlag} is not valid. "
            f"Valid values are 103."
        )
...
def IMRPhenomX_Inspiral_Amp_22_Ansatz(
    ...
    Args:
        ...
        powers_of_Mf: Pre-computed powers of Mf
        pWF: Waveform parameter structure containing IMRPhenomXInspiralAmpVersion
