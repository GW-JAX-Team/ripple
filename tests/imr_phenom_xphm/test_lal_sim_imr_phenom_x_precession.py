...
class TestIMRPhenomXGetAndSetPrecessionVariables:
    """Test class for get and set precession variables function"""

    def initialise_xphm_up_to_function(self):
        m1_si = 30.0 * MSUN
        m2_si = 20.0 * MSUN
        ...
        return p_wf, p_prec, lal_params_aux, m1_si, m2_si, chi1x, chi1y, chi1z, chi2x, chi2y, chi2z
    
    def test_get_and_set_precession_variables(self):
        """Test imr_phenom_x_get_and_set_precession_variables function."""
        p_wf, p_prec, lal_params, m1_si, m2_si, chi1x, chi1y, chi1z, chi2x, chi2y, chi2z = self.initialise_xphm_up_to_function()

        # Call the function under test
        _, (p_wf, p_prec, lal_params) = imr_phenom_x_get_and_set_precession_variables(
            p_wf,
            p_prec,
            m1_si,
            m2_si,
